                ...
                <div class="tieude-ttruot">   
                    ...
                    <div class="onhap">
                        <select name="cn" id="cn" onchange="myFunction()">
                            ...
                            <option value="laptop?CN=${c.id}" ${c.id==cnht? "selected":""}>${c.name}</option>
                            </c:forEach>
                        </select>
                    </div>
                    </c:if>
                    ...
                    <div class="khung-timkiem">
                        <form action="searchLap?CN=${cnht}" method="post">
            ...
            <div class="noidung">
                ...
                <ul class="phanloai">
                    ...
                    <li class="phanloai-sp ${tag==t.id? "active":""}">
                        <a class="mauchu" href="categoryLaptop?cID=${t.id}&CN=${cnht}">
                            ${t.name}
                        </a>
