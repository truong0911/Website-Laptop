                ...
                <div class="tieude-ttruot">   
                    ...
                    <div class="onhap">
                        <select name="cn" id="cn" onchange="myFunction()">
                            ...
                            <option value="home?CN=${c.id}" ${c.id==cnht? "selected":""}>${c.name}</option>
                            </c:forEach>
                        </select>
                    </div>
                    </c:if>
                    ...
                    <div class="khung-timkiem">
                        <form action="search?CN=${cnht}" method="post">
                ...
                <div class="pagination">
                    <c:if test="${tag<1}">
                        <c:forEach begin="1" end="${endP}" var="i">
                            <a href="home?index=${i}&&kind=${tag}&CN=${cnht}" class="${tagpage==i? "active":""}">${i}</a>
                        </c:forEach> 
                    </c:if>   
                    <c:if test="${tag>=1}">
                        <c:forEach begin="1" end="${endP}" var="i">
                            <a href="category?index=${i}&&kind=${tag}&CN=${cnht}" class="${tagpage==i? "active":""}">${i}</a>
                        </c:forEach> 
                    </c:if>   
                </div>
            </div>
