...
public class quanlytaikhoan extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String kind = request.getParameter("use");
        if (kind == null || kind.equals("0")){
            ArrayList<Account> listA = loginDao.getAllAccount("Customer");
            request.setAttribute("listA", listA);
            kind = "0";
        }
        else {
            ArrayList<Account> listA = loginDao.getAllAccount("Employee");
            request.setAttribute("listA", listA);
        }
        request.setAttribute("uid", kind);
